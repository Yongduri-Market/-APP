...
class PersonReport2Screen extends StatefulWidget {
  const PersonReport2Screen({super.key});

  @override
  State<PersonReport2Screen> createState() => _PersonReport2State();
}

class _PersonReport2State extends State<PersonReport2Screen> {
